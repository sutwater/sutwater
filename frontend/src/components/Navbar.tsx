...
import { ChevronDown, User, Settings, LogOut, Edit, X, Check, Bell } from 'lucide-react';
...
const NotificationDropdown = ({
  ...
  const [isOpen, setIsOpen] = useState(false);
  const [localNotifications, setLocalNotifications] = useState<NotificationInterface[]>(notification);
  const dropdownRef = useRef<HTMLDivElement>(null);
